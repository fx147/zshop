...
<head>
    ...
    <script>
        function reloadImage() {
            $('#randImage').attr("src","${pageContext.request.contextPath}/backend/sysuser/image?time="+new Date().getTime());
            $('#code').val('');
        }
                ...
                fields:{
                    ...
                    code:{
                        validators:{
                            ...
                            remote:{
                                url:'${pageContext.request.contextPath}/backend/sysuser/checkCode',
                                message:'验证码错误'
                            }
                        }
                    }
        ...
        <div class="panel-body">
            ...
            <form id="frmLogin" action="${pageContext.request.contextPath}/backend/sysuser/login" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" id="code" placeholder="验证码" name="code">
                    </div>
                    <div class="col-sm-2">
                        <!-- 验证码 -->
                        <img id="randImage" class="img-rounded" src="${pageContext.request.contextPath}/backend/sysuser/image" style="height: 32px; width: 70px;"/>
                    </div>
                    <div class="col-sm-2">
